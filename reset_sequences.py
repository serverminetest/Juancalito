#!/usr/bin/env python3
"""
Script para reiniciar las secuencias de ID en PostgreSQL
Esto hará que los nuevos registros empiecen desde ID 1
"""
...
def reset_sequences():
    """Reinicia todas las secuencias de ID a 1"""
    
    # Obtener URL de la base de datos
    database_url = os.getenv('DATABASE_PUBLIC_URL') or os.getenv('DATABASE_URL')
    
    if not database_url:
        print("❌ Error: No se encontró DATABASE_URL o DATABASE_PUBLIC_URL")
        return False
    ...
    try:
        ...
        print("\n🎉 ¡Secuencias reiniciadas exitosamente!")
        print("\n📋 Resumen:")
...
def main():
    print("🔄 REINICIO DE SECUENCIAS DE ID")
    print("=" * 50)
    print("Este script reiniciará las secuencias de ID para que")
    print("los nuevos registros empiecen desde 1.")
    print()
